...
class ConvNormActPolicy:
    ...
    def __init__(self, name):
        ...
        if self._name.count('_') != 2:
            raise ValueError('Policy name should cotain 3 parts separated with _')

        self._conv_type, self._norm_type, self._act_type = self._name.split('_')
...
def default_policy():
    return ConvNormActPolicy('conv_bn_relu')
