...
class TestModel(testing.TestCase):
    ...
    def test_residual_gamma(self):
        ...
        expected_gammas = [
            ...
            ("stage_2_attn_0_swin_norm", 0.006004),
            ("stage_2_attn_0_mlpconv_norm", 0.006004),
            ("stage_2_attn_1_swin_norm", 0.005338),
            ("stage_2_attn_1_mlpconv_norm", 0.005338),
            ("stage_2_attn_2_slide_norm", 0.004672),
            ("stage_2_attn_2_mlpconv_norm", 0.004672),
            ("stage_2_attn_3_swin_norm", 0.004006),
            ("stage_2_attn_3_mlpconv_norm", 0.004006),
            ("stage_2_attn_4_swin_norm", 0.00334),
            ("stage_2_attn_4_mlpconv_norm", 0.00334),
            ("stage_2_attn_5_slide_norm", 0.002674),
            ("stage_2_attn_5_mlpconv_norm", 0.002674),
            ("stage_3_attn_0_swin_norm", 0.0020079999999999994),
        ...
        actual_gammas = TestModel._values_from_config(
            config,
            [
                "SegMe>Policy>Normalization>GroupNorm",
                "SegMe>Policy>Normalization>LayerNorm",
            ],
            "gamma_initializer",
        )
        actual_gammas = [
