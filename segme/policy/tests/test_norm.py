...
class TestFilterResponseNorm(test_combinations.TestCase):
    ...
    def test_value(self, dformat='channels_last', dtype='float32'):
        inputs = np.array([
            0.18, 0.77, 0.59, 0.12, 0.39, 0.15, 0.02, 0.19, 0.81, 0.29, 0.75, 0.95, 0.67, 0.54, 0.17, 0.1, 0.79, 0.96,
            0.57, 0.73, 0.98, 0.43, 0.1, 0.95, 0.55, 0.26, 0.14, 0.56, 0.97, 0.54, 0.76, 0.95, 0.58, 0.31, 0.69, 0.96,
            0.71, 0.71, 0.92, 0.19, 0.99, 0.4, 0.34, 0.45, 0.34, 0.92, 0.45, 0.87, 0.15, 0.86, 0.89, 0.14, 0.02, 0.32,
            0.2, 0.7, 0.11, 0.54, 0.4, 0.43, 0.4, 0.63, 0.84, 0.59, 0.65, 0.07, 0.59, 0.54, 0.7, 0.29, 1.0, 0.44, 0.64,
            0.23, 0.1, 0.66, 0.3, 0.05, 0.01, 0.88, 0.6, 0.8, 0.3, 0.73, 0.73, 0.55, 0.6, 0.49, 0.37, 0.21, 0.25, 0.28,
            0.11, 0.51, 0.82, 0.03, 0.66, 0.92, 0.94, 0.65, 0.95, 0.89, 0.93, 0.52, 0.58, 0.73, 0.98, 0.55, 0.37, 0.16,
            0.56, 0.96, 0.14, 0.95, 0.31, 0.38, 0.12, 0.47, 0.44, 1.0, 0.32, 0.95, 0.44, 0.34, 0.79, 0.18, 0.26, 0.62,
            0.13, 0.51, 0.23, 0.94, 0.48, 0.48, 0.43, 0.81, 0.33, 0.42, 0.97, 0.42, 0.8, 0.3, 0.78, 0.98, 0.18, 0.98,
            0.5, 0.31, 0.98, 0.12, 0.32, 0.91, 0.8, 0.56, 0.42, 0.09, 0.26, 0.56, 0.94, 0.63, 0.7, 0.19, 0.15, 0.82,
            0.88, 0.09, 0.42, 0.88, 0.55, 0.14, 0.53, 0.23, 0.03, 0.68, 0.14, 0.66, 0.18, 0.83, 0.49, 0.83, 0.44, 0.43,
            0.75, 0.03, 0.79, 0.01, 0.47, 0.82, 0.42, 0.91, 0.27, 0.03]).reshape((2, 4, 4, 6)).astype(dtype)
        expected = np.array([
            0.3654, 1.2314, 0.9592, 0.2429, 0.6109, 0.2461, 0.0406, 0.3038, 1.3169, 0.587, 1.1748, 1.5584, 1.3602,
            0.8635, 0.2764, 0.2024, 1.2375, 1.5749, 1.1572, 1.1674, 1.5933, 0.8704, 0.1566, 1.5584, 1.1166, 0.4158,
            0.2276, 1.1336, 1.5195, 0.8859, 1.5429, 1.5192, 0.9429, 0.6275, 1.0809, 1.5749, 1.4414, 1.1354, 1.4957,
            0.3846, 1.5508, 0.6562, 0.6902, 0.7196, 0.5528, 1.8623, 0.7049, 1.4272, 0.3045, 1.3753, 1.4469, 0.2834,
            0.0313, 0.525, 0.406, 1.1194, 0.1788, 1.0931, 0.6266, 0.7054, 0.8121, 1.0075, 1.3656, 1.1943, 1.0182,
            0.1148, 1.1978, 0.8635, 1.138, 0.587, 1.5665, 0.7218, 1.2993, 0.3678, 0.1626, 1.336, 0.4699, 0.082, 0.0203,
            1.4073, 0.9755, 1.6194, 0.4699, 1.1975, 1.482, 0.8795, 0.9755, 0.9919, 0.5796, 0.3445, 0.5075, 0.4478,
            0.1788, 1.0324, 1.2845, 0.0492, 1.3479, 1.3842, 1.5121, 1.0982, 1.5247, 1.3422, 1.8993, 0.7824, 0.933,
            1.2334, 1.5728, 0.8294, 0.7556, 0.2407, 0.9008, 1.6219, 0.2247, 1.4327, 0.6331, 0.5718, 0.193, 0.7941,
            0.7062, 1.5081, 0.6535, 1.4294, 0.7078, 0.5744, 1.2679, 0.2715, 0.531, 0.9329, 0.2091, 0.8617, 0.3691,
            1.4176, 0.9803, 0.7222, 0.6917, 1.3685, 0.5296, 0.6334, 1.981, 0.6319, 1.2869, 0.5069, 1.2518, 1.4779,
            0.3676, 1.4745, 0.8043, 0.5238, 1.5728, 0.181, 0.6535, 1.3692, 1.2869, 0.9461, 0.6741, 0.1357, 0.531,
            0.8426, 1.5121, 1.0644, 1.1235, 0.2865, 0.3063, 1.2338, 1.4155, 0.1521, 0.6741, 1.3271, 1.1232, 0.2106,
            0.8525, 0.3886, 0.0481, 1.0255, 0.2859, 0.993, 0.2895, 1.4023, 0.7864, 1.2517, 0.8986, 0.647, 1.2064,
            0.0507, 1.2679, 0.0151, 0.9598, 1.2338, 0.6756, 1.5375, 0.4333, 0.0452]).reshape((2, 4, 4, 6)).astype(dtype)
