...
from segme.policy.stdconv import StandardizedConv2D
...
class SameConv(layers.Conv2D):
    def __init__(self, filters, kernel_size, strides=(1, 1), data_format=None, dilation_rate=(1, 1), groups=1,
        ...
        self.same_pad = SamePadding(kernel_size, strides, dilation_rate)
...
class SameStandardizedConv(StandardizedConv2D):
    def __init__(self, filters, kernel_size, strides=(1, 1), data_format=None, dilation_rate=(1, 1), groups=1,
                 activation=None, use_bias=True, kernel_initializer=None, bias_initializer='zeros',
                 kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None,
                 bias_constraint=None, **kwargs):
        kwargs.pop('padding', None)
        self.same_pad = SamePadding(kernel_size, strides, dilation_rate)
...
class SameDepthwiseConv(layers.DepthwiseConv2D):
    def __init__(self, kernel_size, strides=(1, 1), data_format=None, dilation_rate=(1, 1), activation=None,
                 use_bias=True, kernel_initializer=None, bias_initializer='zeros', kernel_regularizer=None,
