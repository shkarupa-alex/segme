from tf_keras import constraints, initializers, layers, regularizers
from tf_keras.saving import register_keras_serializable
from tf_keras.src.utils.tf_utils import shape_type_conversion
from segme.policy import cnapol


def Conv(filters, kernel_size, strides=(1, 1), padding='same', data_format=None, dilation_rate=(1, 1), activation=None,
...
def Norm(data_format=None, epsilon=None, gamma_initializer='ones', policy=None, **kwargs):
    policy = cnapol.deserialize(policy or cnapol.global_policy())

    kwargs.update({'gamma_initializer': gamma_initializer, 'data_format': data_format})
