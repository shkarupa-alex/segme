...
class TestMakeCoords(testing.TestCase):
    def test_value(self):
        expected = np.array(
            [
                [
...
class TestQueryFeatures(testing.TestCase):
    ...
    def test_complex(self):
        ...
        # Channel order in torch.nn.functional.unfold is different from
