...
class RSU7(layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.cbr5 = ConvNormRelu(self.mid_features, 3)
        self.pool5 = layers.MaxPool2D(2, padding='same')

        self.cbr6 = ConvNormRelu(self.mid_features, 3)

        self.cbr7 = ConvNormRelu(self.mid_features, 3, dilation_rate=2)

        self.cbr6d = ConvNormRelu(self.mid_features, 3)
        self.cbr5d = ConvNormRelu(self.mid_features, 3)
