...
class HqsCrm(layers.Layer):
    def __init__(self, aspp_filters, aspp_drop, mlp_units, **kwargs):
        ...
        self.input_spec = [
            ...
            InputSpec(ndim=4, axes={-1: 2}, dtype="float32"),  # coord
        ]
    ...
    def build(self, input_shape):
        ...
        self.decoder = Decoder(
            self.aspp_filters, self.aspp_drop, self.mlp_units
        )
...
def build_hqs_crm(
    aspp_filters=(64, 64, 128), aspp_drop=0.5, mlp_units=(32, 32, 32, 32)
):
    inputs = [
