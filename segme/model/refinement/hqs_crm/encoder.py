...
class Encoder(layers.Layer):
    def __init__(self, **kwargs):
        ...
        self.input_spec = layers.InputSpec(ndim=4, axes={-1: 4})
    ...
    def build(self, input_shape):
        ...
        ext_config = patch_config(ext_config, [2], 'mean', lambda old: old + [0.408])
        ext_config = patch_config(ext_config, [2], 'variance', lambda old: old + [0.492 ** 2])
