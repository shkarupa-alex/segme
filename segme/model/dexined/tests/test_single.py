...
class TestDexiNedSingleConvBlock(keras_parameterized.TestCase):
    def test_layer(self):
        testing_utils.layer_test(
            DexiNedSingleConvBlock,
        ...
        testing_utils.layer_test(
            DexiNedSingleConvBlock,
            kwargs={'out_features': 5, 'kernel_size': 2, 'stride': 2,
                    'weight_norm': True, 'kernel_initializer': const_init},
            input_shape=[2, 16, 16, 3],
            input_dtype='float32',
