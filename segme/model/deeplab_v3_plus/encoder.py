...
class Encoder(layers.Layer):
    def __init__(self, bone_arch, bone_init, bone_train, aspp_filters, aspp_stride, **kwargs):
    ...
    def compute_output_shape(self, input_shape):
        low_feats_shape, high_feats_shape = self.bone.compute_output_shape(input_shape)
