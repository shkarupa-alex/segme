...
class TestComposeTwo(unittest.TestCase):
    def test_compose_crop(self):
        fg0 = np.random.uniform(0.0, 255.0, (16, 24, 3)).astype("uint8")
        alpha0 = np.random.uniform(0.0, 255.0, (16, 24, 1)).astype("uint8")
        fg1 = np.random.uniform(0.0, 255.0, (28, 24, 3)).astype("uint8")
        alpha1 = np.random.uniform(0.0, 255.0, (24, 16, 1)).astype("uint8")
    ...
    def test_compose_solve(self):
        fg0 = np.random.uniform(0.0, 255.0, (16, 24, 3)).astype("uint8")
        alpha0 = np.random.uniform(0.0, 255.0, (16, 24, 1)).astype("uint8")
        fg1 = np.random.uniform(0.0, 255.0, (24, 16, 3)).astype("uint8")
        alpha1 = np.random.uniform(0.0, 255.0, (24, 16, 1)).astype("uint8")
