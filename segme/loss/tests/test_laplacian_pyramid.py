...
class TestLaplacianPyramidLoss(keras_parameterized.TestCase):
    ...
    def test_zeros(self):
        ...
        result = laplacian_pyramid_loss(y_true=targets, y_pred=probs, levels=1)
    ...
    def test_value_4d(self):
        ...
        result = laplacian_pyramid_loss(y_true=targets, y_pred=probs)
        result = self.evaluate(result).item()

        self.assertAllClose(result, 3.398733139038086)
        # self.assertAllClose(result, 3.9416346549987793)  # Without scaling factor
