...
class TestMeanSquaredError(test_combinations.TestCase):
    ...
    def test_zeros(self):
        ...
        result = mean_squared_error(y_true=targets, y_pred=logits, sample_weight=None, from_logits=True)
    ...
    def test_model(self):
        ...
        model.compile(loss='SegMe>Loss>MeanSquaredError', run_eagerly=test_utils.should_run_eagerly())
