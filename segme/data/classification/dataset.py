...
from segme.data.classification.tree import flat21841_class_map
from segme.data.classification.tree import flat21843_class_map
from segme.data.classification.tree import synsets_1k_21k
from segme.data.classification.tree import tree_class_map
from segme.data.common.cutmixup import cut_mix_up
from segme.data.common.module import tensorflow_datasets as tfds
from segme.data.common.randaug import rand_augment_full
...
class Imagenet21k1k(tfds.core.GeneratorBasedBuilder):
    ...
    def _label_from_valname(self, file_path):
        if not self._val_to_label_labels:
            ...
            with gfile.GFile(os.fspath(labels_path)) as f:
...
def _transform_examples(
    ...
    if augment:
        images = convert_image_dtype(images, "float32")
        ...
        images = ops.round(images * 255.0)  # TODO
