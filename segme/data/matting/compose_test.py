...
from segme.data.matting.compose import compose_batch
from segme.data.matting.compose import compose_two
from segme.data.matting.compose import random_compose
from segme.utils.matting.compose import compose_two as compose_two_np
