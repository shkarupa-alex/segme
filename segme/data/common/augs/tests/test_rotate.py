...
from segme.data.common.augs.rotate import _rotate
from segme.data.common.augs.rotate import _rotate_ccw
from segme.data.common.augs.rotate import _rotate_cw
from segme.data.common.augs.rotate import rotate
from segme.data.common.augs.rotate import rotate_cw
from segme.data.common.augs.tests.testing_utils import aug_samples
from segme.data.common.augs.tests.testing_utils import max_diff
