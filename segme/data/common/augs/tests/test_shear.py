...
from segme.data.common.augs.shear import _shear_x
from segme.data.common.augs.shear import _shear_y
...
class TestShearX(testing.TestCase):
    def test_ref(self):
...
class TestShearY(testing.TestCase):
    def test_ref(self):
